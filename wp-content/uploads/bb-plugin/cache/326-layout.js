...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='http://fitnesshack.org/wp-admin/admin-ajax.php';var flBuilderUrl='http://fitnesshack.org/wp-content/plugins/beaver-builder-lite-version/';