 ...
 //ADD SYNONYMS
	jQuery('#add_synonyms').click(function(){
		...
		//update database with new values
			jQuery.ajax({
				url : jQuery('#wp_spinner_rewrite_source').val() + '&action=custom_add',
				type : 'POST',
				data : {id:lastKey, thesaurs:jQuery('#treasures').val(),value:newLine},
	...
	jQuery('#delete_synonyms').click(function(){
				...
				jQuery.ajax({
					url : jQuery('#wp_spinner_rewrite_source').val() + '&action=custom_delete',
					type : 'POST',
					data : {id:  selected , thesaurs:jQuery('#treasures').val()},
	...
	jQuery('#save_synonyms').click(function(){
		...
		//update database with new values
		jQuery.ajax({
			url : jQuery('#wp_spinner_rewrite_source').val() + '&action=custom_edit',
			type : 'POST',
			data : {id: jQuery('#word_select').val(), thesaurs:jQuery('#treasures').val(),value:newLine},
